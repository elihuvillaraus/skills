...
**The question** is whatever the user passed (the `/llm-council` arg, or the thing they asked you to run through the council). If it's vague, ask one clarifying question first — a sharp question is worth more than five answers to a fuzzy one.
...
You now hold all five answers and all five reviews. Do **not** just pick the #1 answer, and do **not** drift back toward whatever the user originally implied — synthesize on **merit and consensus**.
